...
public class BlockPos extends Vec3i
{
    ...
    public static final class PooledMutableBlockPos extends BlockPos.MutableBlockPos
    {
        ...
        public BlockPos.PooledMutableBlockPos func_189537_c(Entity p_189537_1_)
        {
            return (BlockPos.PooledMutableBlockPos)super.func_189535_a(p_189537_1_);
        }

        public BlockPos.PooledMutableBlockPos set(double xIn, double yIn, double zIn)
        {
            return (BlockPos.PooledMutableBlockPos)super.func_189532_c(xIn, yIn, zIn);
        }

        public BlockPos.PooledMutableBlockPos set(Vec3i vec)
        {
            return (BlockPos.PooledMutableBlockPos)super.func_189533_g(vec);
        }

        public BlockPos.PooledMutableBlockPos offsetMutable(EnumFacing facing)
        {
            return (BlockPos.PooledMutableBlockPos)super.func_189536_c(facing);
        }

        public BlockPos.PooledMutableBlockPos func_189538_d(EnumFacing p_189538_1_, int p_189538_2_)
        {
            return (BlockPos.PooledMutableBlockPos)super.func_189534_c(p_189538_1_, p_189538_2_);
        }
    }
}
